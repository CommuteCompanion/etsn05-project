...
`
    ...
    const controller = {
        submitSearch: e => {
            ...
            const stop = document.getElementById('search-stop');
            ...
            controller.performSearch({userId, start, stop, departureTime})
        },
        ...
        load: () => {
            ...
            controller.performSearch({userId: null, start: null, stop: null, departureTime: null});
        }
    };
