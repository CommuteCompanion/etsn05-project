...
public class UserDataAccessTest extends BaseDataAccessTest {
    ...
    public void addNewUser() {
        userDao.addUser(new Credentials("Generic", "qwerty", Role.USER), "first name", "last name", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    ...
    public void addDuplicatedUser() {
        userDao.addUser(new Credentials("Gandalf", "mellon", Role.USER), "Gandalf", "the Gray", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
        userDao.addUser(new Credentials("Gandalf", "vapenation", Role.USER), "Gandalf", "the Gray", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    }
    ...
    public void removeUser() {
        User user = userDao.addUser(new Credentials("Sven", "a", Role.ADMIN), "Sven", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    ...
    public void authenticateNewUser() {
        userDao.addUser(new Credentials("Pelle", "!2", Role.USER), "Pelle", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    ...
    public void authenticateNewUserTwice() {
        userDao.addUser(new Credentials("Elin", "password", Role.USER), "Elin", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    ...
    public void removeSession() {
        userDao.addUser(new Credentials("MormorElsa", "kanelbulle", Role.USER), "Elsa", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    ...
    public void failedAuthenticate() {
        userDao.addUser(new Credentials("steffe", "kittylover1996!", Role.USER), "Stefan", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
        userDao.authenticate(new Credentials("steffe", "cantrememberwhatitwas! nooo!", Role.NONE));
    }

    @Test
    public void checkSession() {
        userDao.addUser(new Credentials("uffe", "genius programmer", Role.ADMIN), "Ulf", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
    ...
    public void checkRemovedSession() {
        userDao.addUser(new Credentials("lisa", "y", Role.ADMIN), "Lisa", "Svensson", "0", "a@a", 0, Timestamp.valueOf("2018-01-01 00:00:00"), true);
