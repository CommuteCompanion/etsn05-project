...
public class BaseResourceTest extends JerseyTest {
    ...
    protected static final User ADMIN = new User(1, Role.ADMIN, "admin@lu.se", "Admin", "-", "", 0, Date.valueOf("2018-01-01"), false, 0, 0, 0);
    protected static final Credentials ADMIN_CREDENTIALS = new Credentials("admin@lu.se", "password", Role.ADMIN, ADMIN);
    protected static final User TEST = new User(2, Role.USER, "test@lu.se", "Test", "Smith", "+4670207579", 0, Date.valueOf("1995-01-01"), true, 0, 0, 0);
