...
public class BaseResourceTest extends JerseyTest {
    ...
    protected static final User ADMIN = new User(1, Role.ADMIN, "Admin", "Admin", "-", "", "admin@commutecompanion.se", 0, Date.valueOf("2018-01-01").getTime(), false, 0, 0, 0);
    protected static final Credentials ADMIN_CREDENTIALS = new Credentials("Admin", "password", Role.ADMIN, ADMIN);
    protected static final User TEST = new User(2, Role.USER, "Test", "Test", "Smith", "+4670207579", "test@commutecompanion.se", 0, Date.valueOf("1995-01-01").getTime(), true, 0, 0, 0);
    protected static final Credentials TEST_CREDENTIALS = new Credentials("Test", "password", Role.USER, TEST);
